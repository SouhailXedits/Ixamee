...
const StatistiquesItems = () => {
  ...
  return ( 
    ...
    <PieChartItem series={[11, 11, 13, 8]} colors={['#12b76a', '#f04438', '#1b8392', '#f69d16']} numberOfStudent={29} />
      ...
      <div className="flex ">
        ...
        (
          ...
          <div className="w-[5.08px] h-14 rounded-[126.89px]"  style={{backgroundColor:item.color}}/>
        <div className="flex flex-col gap-1 pl-4">
          <span className=" text-[#727272]">{item.firstMessage}</span>
          <span className="text-[15px]  text-xl
           font-bold  leading-9" >{item.studentNumber} étudiants </span>
        </div>
          </div>
