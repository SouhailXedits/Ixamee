  ...
  return (
    ...
    >
      ...
      <div className="flex items-start justify-between w-full">
        ...
        <div className="flex w-[47px] h-[47px] inline-flex mt-[18px] bg-[#1B8392] rounded-xl items-end w-full justify-start flex-col items-center text-[#FFFFFF] ">
