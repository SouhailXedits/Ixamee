...
type DashboradBulletinsDesEtudiantsProps = {
  etabId: string;
  classes: any;
};

const DashboradBulletinsDesEtudiants = ({ etabId, classes }: DashboradBulletinsDesEtudiantsProps) => {
  return (
    <div className="flex flex-col gap-4">
      <div className="flex justify-between w-full">
        <div className="flex items-center gap-4">
          <Image src="/dashboard/bulttin/bulletinsIcon.svg" alt="bulletins" width={21} height={21} />
