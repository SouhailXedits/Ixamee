  ...
  return (
    <div className="flex gap-4 ">
      ...
      <div className="w-[260.50px] h-[271px] py-[15px] bg-[#F0F6F8] rounded-[20px] flex-col justify-center items-center gap-[38px] inline-fle p-5">
        ...
        <div className="items-center justify-center text-center font-[300]  text-10 opacity-70 pb-8">
          Créé le 27/04/2023
        </div>
        <div className="p-2 pb-5 flex justify-center items-center w-full">
          <span className=" bg-[#1B8392] w-32 p-3  text-white flex items-center justify-center rounded-lg font-extrabold text-[17px] hover:opacity-90 duration-150 cursor-pointer">
            Ouvrir
          </span>
        </div>
      </div>
